...
export default function VerifyOtpPage() {
  ...
  const verifyOtpMutation = useMutation({
    ...
    onSuccess: () => {
      toast.success(t('verifyOtpSuccess'));
    },
    onError: (error: AxiosError) => {
      let errorMessage = t('verifyOtpError');
              ...
              <FieldGroup>
                ...
                <Field>
                  ...
                  <Input
                    ...
                    className={`${dir === 'rtl' ? 'text-right placeholder:text-[14px]' : 'text-left placeholder:text-[14px]'} ${errors.otp ? 'border-red-500' : ''}`}
                    disabled={verifyOtpMutation.isPending}
                    {...register("otp", {
